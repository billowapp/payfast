...
[
    ...
    'merchant' => [
        ...
        'cancel_url' => env('PF_CANCEL_URL', 'http://your-domain.co.za/success'), // Redirect URL on Cancellation.
        'notify_url' => env('PF_ITN_URL', 'http://your-domain.co.za/success'), // ITN URL.
    ],
